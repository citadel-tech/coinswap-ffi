...
mkdir -p ../coinswap-kotlin/lib/src/main/resources/$RESOURCE_DIR_X86_64/
...
cp ./target/$COMPILATION_TARGET_X86_64/debug/$LIB_NAME ../coinswap-kotlin/lib/src/main/resources/$RESOURCE_DIR_X86_64
cp ./target/$COMPILATION_TARGET_X86_64/debug/libcoinswap_ffi.d ../coinswap-kotlin/lib/src/main/resources/$RESOURCE_DIR_X86_64/
cp ./target/$COMPILATION_TARGET_X86_64/debug/$LIB_NAME ../oinswap-kotlin/lib/src/main/kotlin/
cp ./target/debug/uniffi-bindgen ../coinswap-kotlin/lib/src/main/resources/$RESOURCE_DIR_X86_64
cp ./target/debug/uniffi-bindgen.d ../coinswap-kotlin/lib/src/main/resources/$RESOURCE_DIR_X86_64

echo ""
echo "====================================="
echo "Built for: x86_64"
echo "Binary location: lib/src/main/resources/$RESOURCE_DIR_X86_64/$LIB_NAME"
echo "====================================="
