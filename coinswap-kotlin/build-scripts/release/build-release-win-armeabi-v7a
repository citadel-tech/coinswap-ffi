...
export CC_armv7_linux_androideabi="$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/windows-x86_64/bin/armv7a-linux-androideabi24-clang"
export CXX_armv7_linux_androideabi="$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/windows-x86_64/bin/armv7a-linux-androideabi24-clang++"
