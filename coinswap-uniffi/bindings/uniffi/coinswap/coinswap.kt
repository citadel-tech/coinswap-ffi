...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_coinswap_ffi_checksum_func_create_swap_params(): Short
    ...
    fun uniffi_coinswap_ffi_checksum_method_taker_get_wallet_balances(): Short
    ...
    fun uniffi_coinswap_ffi_checksum_method_taker_send_coinswap(): Short

    fun uniffi_coinswap_ffi_checksum_method_taker_sync_offerbook(): Short

    fun uniffi_coinswap_ffi_checksum_method_taker_sync_wallet(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_backup(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_get_balances(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_get_name(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_get_next_external_address(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_get_next_internal_addresses(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_list_all_utxos(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_lock_unspendable_utxos(): Short

    fun uniffi_coinswap_ffi_checksum_method_wallet_sync_and_save(): Short

    fun uniffi_coinswap_ffi_checksum_constructor_taker_init(): Short

    fun uniffi_coinswap_ffi_checksum_constructor_wallet_init(): Short
...
internal interface UniffiLib : Library {
    ...
    // FFI functions
    fun uniffi_coinswap_ffi_fn_clone_address(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_free_address(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_clone_amount(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_free_amount(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_clone_outpoint(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_free_outpoint(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_clone_scriptbuf(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_free_scriptbuf(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun uniffi_coinswap_ffi_fn_method_taker_get_wallet_balances(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue
    ...
    fun uniffi_coinswap_ffi_fn_method_taker_send_coinswap(
        `ptr`: Pointer,
    ...
    fun uniffi_coinswap_ffi_fn_method_taker_sync_wallet(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_clone_txid(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_free_txid(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_clone_wallet(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_free_wallet(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_constructor_wallet_init(
        `path`: RustBuffer.ByValue,
        `rpcConfig`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_method_wallet_backup(
        `ptr`: Pointer,
        `path`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_method_wallet_get_balances(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_coinswap_ffi_fn_method_wallet_get_name(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_coinswap_ffi_fn_method_wallet_get_next_external_address(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_coinswap_ffi_fn_method_wallet_get_next_internal_addresses(
        `ptr`: Pointer,
        `count`: Int,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_coinswap_ffi_fn_method_wallet_list_all_utxos(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_coinswap_ffi_fn_method_wallet_lock_unspendable_utxos(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun uniffi_coinswap_ffi_fn_method_wallet_sync_and_save(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun uniffi_coinswap_ffi_fn_func_create_swap_params(
        `sendAmountSats`: Long,
        `makerCount`: Int,
        `outpoints`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_coinswap_ffi_checksum_func_create_swap_params() != 64040.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_display_offer() != 29310.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_fetch_all_makers() != 10547.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_fetch_good_makers() != 31706.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_get_all_good_makers() != 35374.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_get_wallet_balances() != 36988.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_get_wallet_name() != 45636.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_recover_from_swap() != 52494.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_send_coinswap() != 5303.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_sync_offerbook() != 43682.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_taker_sync_wallet() != 64892.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_backup() != 31141.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_get_balances() != 8214.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_get_name() != 46731.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_get_next_external_address() != 44927.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_get_next_internal_addresses() != 37843.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_list_all_utxos() != 25489.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_lock_unspendable_utxos() != 58679.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_method_wallet_sync_and_save() != 32529.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_constructor_taker_init() != 56903.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_coinswap_ffi_checksum_constructor_wallet_init() != 14020.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
open class Address :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_free_address(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer =
        uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_clone_address(pointer!!, status)
        }
...
public object FfiConverterTypeAddress : FfiConverter<Address, Pointer> {
    override fun lower(value: Address): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): Address = Address(value)
...
open class Amount :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_free_amount(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer =
        uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_clone_amount(pointer!!, status)
        }
...
public object FfiConverterTypeAmount : FfiConverter<Amount, Pointer> {
    override fun lower(value: Amount): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): Amount = Amount(value)
...
open class OutPoint :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_free_outpoint(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer =
        uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_clone_outpoint(pointer!!, status)
        }
...
public object FfiConverterTypeOutPoint : FfiConverter<OutPoint, Pointer> {
    override fun lower(value: OutPoint): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): OutPoint = OutPoint(value)
...
public interface ScriptBufInterface {
    companion object
}

open class ScriptBuf :
    Disposable,
    AutoCloseable,
    ScriptBufInterface {
    constructor(pointer: Pointer) {
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_free_scriptbuf(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer =
        uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_clone_scriptbuf(pointer!!, status)
        }
 ...
 * @suppress
 */
public object FfiConverterTypeScriptBuf : FfiConverter<ScriptBuf, Pointer> {
    override fun lower(value: ScriptBuf): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): ScriptBuf = ScriptBuf(value)
    ...
    override fun allocationSize(value: ScriptBuf) = 8UL
...
public interface TakerInterface {
     ...
     */
    fun `displayOffer`(`makerOffer`: MakerOffer): kotlin.String
     ...
     * Get wallet balances
     */
    fun `getWalletBalances`(): Balances
    ...
    fun `sendCoinswap`(`swapParams`: SwapParams)
...
open class Taker :
     ...
     */
    @Throws(TakerException::class)
    override fun `getWalletBalances`(): Balances =
        FfiConverterTypeBalances.lift(
            callWithPointer {
                uniffiRustCallWithError(TakerException) { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_taker_get_wallet_balances(
                        it,
                        _status,
                    )
                }
    ...
    @Throws(TakerException::class)
    override fun `sendCoinswap`(`swapParams`: SwapParams) =
        callWithPointer {
            uniffiRustCallWithError(TakerException) { _status ->
                UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_taker_send_coinswap(
                    it,
    ...
    @Throws(TakerException::class)
    override fun `syncWallet`() =
        callWithPointer {
            uniffiRustCallWithError(TakerException) { _status ->
                UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_taker_sync_wallet(
                    it,
                    _status,
                )
            }
            ...
            FfiConverterTypeTaker.lift(
                uniffiRustCallWithError(TakerException) { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_constructor_taker_init(
                        ...
                        FfiConverterOptionalTypeTakerBehavior.lower(`behavior`),
...
open class Txid :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_free_txid(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer =
        uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_clone_txid(pointer!!, status)
        }
...
public object FfiConverterTypeTxid : FfiConverter<Txid, Pointer> {
    override fun lower(value: Txid): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): Txid = Txid(value)
...
public interface WalletInterface {
    ...
    fun `listAllUtxos`(): List<UtxoWithSpendInfo>
...
open class Wallet :
    ...
    private class UniffiCleanAction(
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_free_wallet(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer =
        uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_clone_wallet(pointer!!, status)
        }

    @Throws(WalletException::class)
    override fun `backup`(`path`: kotlin.String) =
        callWithPointer {
            uniffiRustCallWithError(WalletException) { _status ->
                UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_backup(
                    it,
    ...
    override fun `getBalances`(): Balances =
        FfiConverterTypeBalances.lift(
            callWithPointer {
                uniffiRustCallWithError(WalletException) { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_get_balances(
                        it,
                        _status,
                    )
                }
        ...
        FfiConverterString.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_get_name(
                        it,
                        _status,
                    )
                }
    ...
    override fun `getNextExternalAddress`(): Address =
        FfiConverterTypeAddress.lift(
            callWithPointer {
                uniffiRustCallWithError(WalletException) { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_get_next_external_address(
                        it,
                        _status,
                    )
                }
    ...
    override fun `getNextInternalAddresses`(`count`: kotlin.UInt): List<Address> =
        FfiConverterSequenceTypeAddress.lift(
            callWithPointer {
                uniffiRustCallWithError(WalletException) { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_get_next_internal_addresses(
                        it,
    ...
    override fun `listAllUtxos`(): List<UtxoWithSpendInfo> =
        FfiConverterSequenceTypeUTXOWithSpendInfo.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_list_all_utxos(
                        it,
                        _status,
                    )
                }
    ...
    override fun `lockUnspendableUtxos`() =
        callWithPointer {
            uniffiRustCallWithError(WalletException) { _status ->
                UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_lock_unspendable_utxos(
                    it,
                    _status,
                )
            }
    ...
    override fun `syncAndSave`() =
        callWithPointer {
            uniffiRustCallWithError(WalletException) { _status ->
                UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_method_wallet_sync_and_save(
                    it,
                    _status,
                )
            }
    ...
    companion object {
        ...
        fun `init`(
            ...
            FfiConverterTypeWallet.lift(
                uniffiRustCallWithError(WalletException) { _status ->
                    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_constructor_wallet_init(
                        FfiConverterString.lower(`path`),
...
public object FfiConverterTypeWallet : FfiConverter<Wallet, Pointer> {
    override fun lower(value: Wallet): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): Wallet = Wallet(value)
...
data class Balances(
    var `regular`: kotlin.ULong,
    var `swap`: kotlin.ULong,
    var `contract`: kotlin.ULong,
    var `fidelity`: kotlin.ULong,
...
public object FfiConverterTypeBalances : FfiConverterRustBuffer<Balances> {
    ...
    override fun allocationSize(value: Balances) =
        (
            FfiConverterULong.allocationSize(value.`regular`) +
                FfiConverterULong.allocationSize(value.`swap`) +
                FfiConverterULong.allocationSize(value.`contract`) +
                FfiConverterULong.allocationSize(value.`fidelity`) +
    ...
    override fun write(
        ...
        FfiConverterULong.write(value.`regular`, buf)
        FfiConverterULong.write(value.`swap`, buf)
        FfiConverterULong.write(value.`contract`, buf)
        FfiConverterULong.write(value.`fidelity`, buf)
...
data class MakerOffer(
    var `baseFee`: kotlin.ULong,
    ...
    var `maxSize`: kotlin.ULong,
    var `minSize`: kotlin.ULong,
    var `address`: kotlin.String,
) {
    companion object
}
 ...
 * @suppress
 */
public object FfiConverterTypeMakerOffer : FfiConverterRustBuffer<MakerOffer> {
    override fun read(buf: ByteBuffer): MakerOffer =
        MakerOffer(
            FfiConverterULong.read(buf),
    ...
    override fun allocationSize(value: MakerOffer) =
        (
            FfiConverterULong.allocationSize(value.`baseFee`) +
                ...
                FfiConverterULong.allocationSize(value.`minSize`) +
    ...
    override fun write(
        ...
        FfiConverterULong.write(value.`baseFee`, buf)
        ...
        FfiConverterULong.write(value.`minSize`, buf)
        FfiConverterString.write(value.`address`, buf)
    }
}

data class MakerStats(
    var `totalMakers`: kotlin.UInt,
    var `onlineMakers`: kotlin.UInt,
    var `avgBaseFee`: kotlin.ULong,
    var `avgAmountRelativeFeePct`: kotlin.Double,
    var `avgTimeRelativeFeePct`: kotlin.Double,
    var `totalLiquidity`: kotlin.ULong,
    var `avgMinSize`: kotlin.ULong,
    var `avgMaxSize`: kotlin.ULong,
) {
    companion object
}
 ...
 * @suppress
 */
public object FfiConverterTypeMakerStats : FfiConverterRustBuffer<MakerStats> {
    override fun read(buf: ByteBuffer): MakerStats =
        MakerStats(
            FfiConverterUInt.read(buf),
            FfiConverterUInt.read(buf),
            FfiConverterULong.read(buf),
    ...
    override fun allocationSize(value: MakerStats) =
        (
            FfiConverterUInt.allocationSize(value.`totalMakers`) +
                FfiConverterUInt.allocationSize(value.`onlineMakers`) +
                FfiConverterULong.allocationSize(value.`avgBaseFee`) +
                FfiConverterDouble.allocationSize(value.`avgAmountRelativeFeePct`) +
                FfiConverterDouble.allocationSize(value.`avgTimeRelativeFeePct`) +
                FfiConverterULong.allocationSize(value.`totalLiquidity`) +
                FfiConverterULong.allocationSize(value.`avgMinSize`) +
                FfiConverterULong.allocationSize(value.`avgMaxSize`)
        )
    ...
    override fun write(
        ...
        FfiConverterUInt.write(value.`totalMakers`, buf)
        FfiConverterUInt.write(value.`onlineMakers`, buf)
        FfiConverterULong.write(value.`avgBaseFee`, buf)
        FfiConverterDouble.write(value.`avgAmountRelativeFeePct`, buf)
        FfiConverterDouble.write(value.`avgTimeRelativeFeePct`, buf)
        FfiConverterULong.write(value.`totalLiquidity`, buf)
        FfiConverterULong.write(value.`avgMinSize`, buf)
        FfiConverterULong.write(value.`avgMaxSize`, buf)
    }
}
...
data class SwapParams(
    ...
    override fun destroy() {
        Disposable.destroy(
            this.`sendAmount`,
            this.`makerCount`,
            this.`manuallySelectedOutpoints`,
        )
    }
...
data class UtxoWithSpendInfo(
    var `utxo`: ListUnspentResultEntry,
 ...
 * @suppress
 */
public object FfiConverterTypeUTXOWithSpendInfo : FfiConverterRustBuffer<UtxoWithSpendInfo> {
    override fun read(buf: ByteBuffer): UtxoWithSpendInfo =
        UtxoWithSpendInfo(
            FfiConverterTypeListUnspentResultEntry.read(buf),
            FfiConverterTypeUtxoSpendInfo.read(buf),
        )

    override fun allocationSize(value: UtxoWithSpendInfo) =
        (
            FfiConverterTypeListUnspentResultEntry.allocationSize(value.`utxo`) +
                FfiConverterTypeUtxoSpendInfo.allocationSize(value.`spendInfo`)
        )

    override fun write(
        value: UtxoWithSpendInfo,
        buf: ByteBuffer,
    ) {
        FfiConverterTypeListUnspentResultEntry.write(value.`utxo`, buf)
 ...
 * @suppress
 */
public object FfiConverterTypeWalletBackup : FfiConverterRustBuffer<WalletBackup> {
    override fun read(buf: ByteBuffer): WalletBackup =
        WalletBackup(
            FfiConverterString.read(buf),
        )

    override fun allocationSize(value: WalletBackup) =
        (
...
sealed class UtxoSpendInfo : Disposable {
    /**
     * Seed Coin
     */
    data class SeedCoin(
        val `path`: kotlin.String,
        val `inputValue`: Amount,
    ) : UtxoSpendInfo() {
        companion object
    }
     ...
     */
    data class IncomingSwapCoin(
        val `multisigRedeemscript`: ScriptBuf,
    ) : UtxoSpendInfo() {
        companion object
    }
     ...
     * Timelock Contract
     */
    data class TimelockContract(
        val `swapcoinMultisigRedeemscript`: ScriptBuf,
        val `inputValue`: Amount,
    ) : UtxoSpendInfo() {
        companion object
    }
     ...
     */
    data class SweptCoin(
        val `path`: kotlin.String,
        val `inputValue`: Amount,
        val `originalMultisigRedeemscript`: ScriptBuf,
    ) : UtxoSpendInfo() {
        companion object
    }
    ...
    override fun destroy() {
        when (this) {
            is UtxoSpendInfo.SeedCoin -> {
                Disposable.destroy(
                    this.`path`,
                    this.`inputValue`,
                )
            }
            is UtxoSpendInfo.IncomingSwapCoin -> {
                Disposable.destroy(
                    this.`multisigRedeemscript`,
                )
            }
            is UtxoSpendInfo.OutgoingSwapCoin -> {
                Disposable.destroy(
                    this.`multisigRedeemscript`,
                )
            }
            is UtxoSpendInfo.TimelockContract -> {
                Disposable.destroy(
                    this.`swapcoinMultisigRedeemscript`,
                    this.`inputValue`,
                )
            }
            is UtxoSpendInfo.HashlockContract -> {
                Disposable.destroy(
                    this.`swapcoinMultisigRedeemscript`,
                    this.`inputValue`,
                )
            }
            is UtxoSpendInfo.FidelityBondCoin -> {
                Disposable.destroy(
                    this.`index`,
                    this.`inputValue`,
                )
            }
            is UtxoSpendInfo.SweptCoin -> {
                Disposable.destroy(
                    this.`path`,
                    this.`inputValue`,
                    this.`originalMultisigRedeemscript`,
                )
            }
        }.let { /* this makes the `when` an expression, which ensures it is exhaustive */ }
    }
    ...
    override fun allocationSize(value: UtxoSpendInfo) =
        when (value) {
            is UtxoSpendInfo.SeedCoin -> {
                ...
                (
                    4UL +
                        ...
                        FfiConverterTypeAmount.allocationSize(value.`inputValue`)
                )
            }
            is UtxoSpendInfo.IncomingSwapCoin -> {
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                (
                    4UL +
                        FfiConverterTypeScriptBuf.allocationSize(value.`multisigRedeemscript`)
                )
            }
            is UtxoSpendInfo.OutgoingSwapCoin -> {
                // Add the size for the Int that specifies the variant plus the size needed for all fields
            ...
            is UtxoSpendInfo.TimelockContract -> {
                ...
                (
                    4UL +
                        FfiConverterTypeScriptBuf.allocationSize(value.`swapcoinMultisigRedeemscript`) +
                        FfiConverterTypeAmount.allocationSize(value.`inputValue`)
                )
            }
            is UtxoSpendInfo.HashlockContract -> {
            ...
            is UtxoSpendInfo.SweptCoin -> {
                ...
                (
                    4UL +
                        FfiConverterString.allocationSize(value.`path`) +
                        FfiConverterTypeAmount.allocationSize(value.`inputValue`) +
                        FfiConverterTypeScriptBuf.allocationSize(value.`originalMultisigRedeemscript`)
                )
            }
        }
    ...
    override fun write(
        ...
        when (value) {
            is UtxoSpendInfo.SeedCoin -> {
                ...
                FfiConverterTypeAmount.write(value.`inputValue`, buf)
                Unit
            }
            is UtxoSpendInfo.IncomingSwapCoin -> {
                buf.putInt(2)
                FfiConverterTypeScriptBuf.write(value.`multisigRedeemscript`, buf)
                Unit
            }
            is UtxoSpendInfo.OutgoingSwapCoin -> {
                buf.putInt(3)
            ...
            is UtxoSpendInfo.TimelockContract -> {
                buf.putInt(4)
                FfiConverterTypeScriptBuf.write(value.`swapcoinMultisigRedeemscript`, buf)
                FfiConverterTypeAmount.write(value.`inputValue`, buf)
                Unit
            }
            is UtxoSpendInfo.HashlockContract -> {
            ...
            is UtxoSpendInfo.SweptCoin -> {
                ...
                FfiConverterString.write(value.`path`, buf)
                FfiConverterTypeAmount.write(value.`inputValue`, buf)
                FfiConverterTypeScriptBuf.write(value.`originalMultisigRedeemscript`, buf)
                Unit
            }
        }.let { /* this makes the `when` an expression, which ensures it is exhaustive */ }
    }
...
public object FfiConverterTypeWalletError : FfiConverterRustBuffer<WalletException> {
    override fun read(buf: ByteBuffer): WalletException =
        when (buf.getInt()) {
            ...
            3 ->
                WalletException.General(
                    FfiConverterString.read(buf),
                )
            4 ->
                WalletException.Json(
                    FfiConverterString.read(buf),
                )
            5 ->
                WalletException.Network(
                    FfiConverterString.read(buf),
                )
            6 ->
                WalletException.AddressParse(
                    FfiConverterString.read(buf),
                )
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: WalletException): ULong =
        when (value) {
            is WalletException.Io -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`msg`)
            )
            is WalletException.Rpc -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`msg`)
            )
            is WalletException.General -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`msg`)
            )
            is WalletException.Json -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`msg`)
            )
            is WalletException.Network -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`msg`)
            )
            is WalletException.AddressParse -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL +
                    FfiConverterString.allocationSize(value.`msg`)
            )
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeTakerBehavior : FfiConverterRustBuffer<TakerBehavior?> {
    override fun read(buf: ByteBuffer): TakerBehavior? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeTakerBehavior.read(buf)
    }

    override fun allocationSize(value: TakerBehavior?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeTakerBehavior.allocationSize(value)
        }
    }
    ...
    override fun write(
        ...
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeTakerBehavior.write(value, buf)
        }
    }
}
 ...
 * @suppress
 */
public object FfiConverterSequenceTypeUTXOWithSpendInfo : FfiConverterRustBuffer<List<UtxoWithSpendInfo>> {
    override fun read(buf: ByteBuffer): List<UtxoWithSpendInfo> {
        val len = buf.getInt()
        return List<UtxoWithSpendInfo>(len) {
            FfiConverterTypeUTXOWithSpendInfo.read(buf)
        }
    }

    override fun allocationSize(value: List<UtxoWithSpendInfo>): ULong {
        val sizeForLength = 4UL
        val sizeForItems = value.map { FfiConverterTypeUTXOWithSpendInfo.allocationSize(it) }.sum()
        return sizeForLength + sizeForItems
    }

    override fun write(
        value: List<UtxoWithSpendInfo>,
        buf: ByteBuffer,
    ) {
        buf.putInt(value.size)
        value.iterator().forEach {
            FfiConverterTypeUTXOWithSpendInfo.write(it, buf)
        }
    }
}
...
fun `createSwapParams`(
    `sendAmountSats`: kotlin.ULong,
    `makerCount`: kotlin.UInt,
    `outpoints`: List<OutPoint>,
): SwapParams =
    FfiConverterTypeSwapParams.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_func_create_swap_params(
                FfiConverterULong.lower(`sendAmountSats`),
                FfiConverterUInt.lower(`makerCount`),
