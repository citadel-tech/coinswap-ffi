...
fun uniffi_coinswap_ffi_checksum_func_create_swap_params(
): Short
fun uniffi_coinswap_ffi_checksum_method_taker_get_wallet_balances(
): Short
fun uniffi_coinswap_ffi_checksum_method_taker_get_wallet_name(
): Short
fun uniffi_coinswap_ffi_checksum_method_taker_send_coinswap(
): Short
fun uniffi_coinswap_ffi_checksum_method_taker_sync_wallet(
): Short
...
fun uniffi_coinswap_ffi_fn_constructor_taker_init(`dataDir`: RustBuffer.ByValue,`walletFileName`: RustBuffer.ByValue,`rpcConfig`: RustBuffer.ByValue,`behavior`: RustBuffer.ByValue,`controlPort`: RustBuffer.ByValue,`torAuthPassword`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun uniffi_coinswap_ffi_fn_method_taker_get_wallet_balances(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_coinswap_ffi_fn_method_taker_get_wallet_name(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_coinswap_ffi_fn_method_taker_send_coinswap(`ptr`: Pointer,`swapParams`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Unit
fun uniffi_coinswap_ffi_fn_method_taker_sync_wallet(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Unit
fun uniffi_coinswap_ffi_fn_clone_wallet(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun uniffi_coinswap_ffi_fn_free_wallet(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Unit
fun uniffi_coinswap_ffi_fn_func_create_default_rpc_config(uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_coinswap_ffi_fn_func_create_swap_params(`sendAmountSats`: Long,`makerCount`: Int,`outpoints`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_coinswap_ffi_checksum_func_create_swap_params() != 14523.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class Taker: Disposable, AutoCloseable, TakerInterface
{
     ...
     * Get wallet balances
     */
    @Throws(TakerException::class)override fun `getWalletBalances`(): Balances {
    ...
    @Throws(TakerException::class)override fun `sendCoinswap`(`swapParams`: SwapParams)
        = 
    callWithPointer {
    uniffiRustCallWithError(TakerException) { _status ->
    ...
    @Throws(TakerException::class)override fun `syncWallet`()
        = 
    callWithPointer {
    uniffiRustCallWithError(TakerException) { _status ->
    ...
    @Throws(TakerException::class) fun `init`(`dataDir`: kotlin.String?, `walletFileName`: kotlin.String?, `rpcConfig`: RpcConfig?, `behavior`: TakerBehavior?, `controlPort`: kotlin.UShort?, `torAuthPassword`: kotlin.String?): Taker {
            return FfiConverterTypeTaker.lift(
    uniffiRustCallWithError(TakerException) { _status ->
    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_constructor_taker_init(
        FfiConverterOptionalString.lower(`dataDir`),FfiConverterOptionalString.lower(`walletFileName`),FfiConverterOptionalTypeRPCConfig.lower(`rpcConfig`),FfiConverterOptionalTypeTakerBehavior.lower(`behavior`),FfiConverterOptionalUShort.lower(`controlPort`),FfiConverterOptionalString.lower(`torAuthPassword`),_status)
}
    )
    }
...
data class SwapParams (
     ...
     */
    var `manuallySelectedOutpoints`: List<kotlin.String>?
) {
...
public object FfiConverterTypeSwapParams: FfiConverterRustBuffer<SwapParams> {
    ...
    override fun allocationSize(value: SwapParams) = (
            ...
            FfiConverterOptionalSequenceString.allocationSize(value.`manuallySelectedOutpoints`)
    )
    ...
    override fun write(value: SwapParams, buf: ByteBuffer) {
            ...
            FfiConverterOptionalSequenceString.write(value.`manuallySelectedOutpoints`, buf)
    }
}
...
public object FfiConverterTypeWalletBackup: FfiConverterRustBuffer<WalletBackup> {
    ...
    override fun write(value: WalletBackup, buf: ByteBuffer) {
...
sealed class Destination {
    ...
    data class Multi(
        val `outputs`: Map<kotlin.String, kotlin.ULong>, 
        val `opReturnData`: kotlin.ByteArray?) : Destination() {
        companion object
    }
    
    data class MultiDynamic(
        val `amount`: kotlin.ULong, 
        val `addresses`: List<kotlin.String>) : Destination() {
        companion object
    }
...
public object FfiConverterTypeDestination : FfiConverterRustBuffer<Destination>{
    ...
    override fun allocationSize(value: Destination) = when(value) {
        ...
        is Destination.Multi -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterMapStringULong.allocationSize(value.`outputs`)
                + FfiConverterOptionalByteArray.allocationSize(value.`opReturnData`)
            )
        }
        is Destination.MultiDynamic -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
    ...
    override fun write(value: Destination, buf: ByteBuffer) {
        when(value) {
            ...
            is Destination.Multi -> {
                buf.putInt(2)
                FfiConverterMapStringULong.write(value.`outputs`, buf)
                FfiConverterOptionalByteArray.write(value.`opReturnData`, buf)
                Unit
            }
            is Destination.MultiDynamic -> {
                buf.putInt(3)
...
public object FfiConverterTypeWalletError : FfiConverterRustBuffer<WalletException> {
    override fun read(buf: ByteBuffer): WalletException {
        ...
        return when(buf.getInt()) {
            1 -> WalletException.Io(
                FfiConverterString.read(buf),
                )
            2 -> WalletException.Rpc(
                FfiConverterString.read(buf),
                )
            3 -> WalletException.General(
                FfiConverterString.read(buf),
                )
            4 -> WalletException.Json(
                FfiConverterString.read(buf),
                )
            5 -> WalletException.Network(
                FfiConverterString.read(buf),
                )
            6 -> WalletException.AddressParse(
                FfiConverterString.read(buf),
                )
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }
...
public object FfiConverterMapStringULong: FfiConverterRustBuffer<Map<kotlin.String, kotlin.ULong>> {
 ...
 fun `createSwapParams`(`sendAmountSats`: kotlin.ULong, `makerCount`: kotlin.UInt, `outpoints`: List<kotlin.String>): SwapParams {
            return FfiConverterTypeSwapParams.lift(
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_coinswap_ffi_fn_func_create_swap_params(
        FfiConverterULong.lower(`sendAmountSats`),FfiConverterUInt.lower(`makerCount`),FfiConverterSequenceString.lower(`outpoints`),_status)
}
    )
    }
