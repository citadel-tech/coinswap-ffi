...
pub const DOCKER_BITCOIN_RPC_URL: &str = "http://localhost:18443";
...
/// Get RPC config for connecting to Docker bitcoind
...
mod tests {
    ...
    #[test]
    #[ignore] // Only run when Docker services are running
