...
cp ./target/$COMPILATION_TARGET/debug/$LIB_NAME ../coinswap-python/src/coinswap/native/$RESOURCE_DIR/
cp ./target/$COMPILATION_TARGET/debug/uniffi-bindgen ../coinswap-python/src/coinswap/native/$RESOURCE_DIR/
