...
class _UniffiConverterTypeAddressType(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return AddressType(
            addr_type=_UniffiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.addr_type)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.addr_type, buf)
...
class MakerOfferCandidate:
    ...
    offer: "typing.Optional[Offer]"
    state: "MakerState"
    protocol: "typing.Optional[MakerProtocol]"
...
class _UniffiConverterTypeMakerOfferCandidate(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return MakerOfferCandidate(
            address=_UniffiConverterTypeMakerAddress.read(buf),
            offer=_UniffiConverterOptionalTypeOffer.read(buf),
            state=_UniffiConverterTypeMakerState.read(buf),
            protocol=_UniffiConverterOptionalTypeMakerProtocol.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterTypeMakerAddress.check_lower(value.address)
        _UniffiConverterOptionalTypeOffer.check_lower(value.offer)
        _UniffiConverterTypeMakerState.check_lower(value.state)
        _UniffiConverterOptionalTypeMakerProtocol.check_lower(value.protocol)

    @staticmethod
    def write(value, buf):
        _UniffiConverterTypeMakerAddress.write(value.address, buf)
        _UniffiConverterOptionalTypeOffer.write(value.offer, buf)
        _UniffiConverterTypeMakerState.write(value.state, buf)
        _UniffiConverterOptionalTypeMakerProtocol.write(value.protocol, buf)
...
class _UniffiConverterTypeMakerProtocol(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return MakerProtocol(
            protocol_type=_UniffiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.protocol_type)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.protocol_type, buf)
...
class _UniffiConverterTypeMakerState(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return MakerState(
            state_type=_UniffiConverterString.read(buf),
            retries=_UniffiConverterOptionalUInt8.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.state_type)
        _UniffiConverterOptionalUInt8.check_lower(value.retries)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.state_type, buf)
        _UniffiConverterOptionalUInt8.write(value.retries, buf)
...
class OfferBook:
    makers: "typing.List[MakerOfferCandidate]"
...
class _UniffiConverterTypeOfferBook(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return OfferBook(
            makers=_UniffiConverterSequenceTypeMakerOfferCandidate.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterSequenceTypeMakerOfferCandidate.check_lower(value.makers)

    @staticmethod
    def write(value, buf):
        _UniffiConverterSequenceTypeMakerOfferCandidate.write(value.makers, buf)
...
class _UniffiConverterOptionalTypeMakerProtocol(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeMakerProtocol.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeMakerProtocol.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeMakerProtocol.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")



class _UniffiConverterOptionalTypeOffer(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeOffer.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeOffer.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeOffer.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")
...
class _UniffiConverterSequenceTypeMakerOfferCandidate(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiConverterTypeMakerOfferCandidate.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiConverterTypeMakerOfferCandidate.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiConverterTypeMakerOfferCandidate.read(buf) for i in range(count)
        ]
...
class TakerProtocol(typing.Protocol):
    ...
    def get_balances(self, ):
        raise NotImplementedError
    def get_next_external_address(self, address_type: "AddressType"):
        raise NotImplementedError
    def get_next_internal_addresses(self, count: "int",address_type: "AddressType"):
        raise NotImplementedError
    def get_transactions(self, count: "typing.Optional[int]",skip: "typing.Optional[int]"):
        raise NotImplementedError
    def get_wallet_name(self, ):
        raise NotImplementedError
    def is_offerbook_syncing(self, ):
        raise NotImplementedError
    ...
    def send_to_address(self, address: "str",amount: "int",fee_rate: "typing.Optional[float]",manually_selected_outpoints: "typing.Optional[typing.List[OutPoint]]"):
        raise NotImplementedError
    def setup_logging(self, data_dir: "typing.Optional[str]"):
        raise NotImplementedError
    def setup_logging_with_level(self, data_dir: "typing.Optional[str]",log_level: "str"):
        raise NotImplementedError
...
class Taker():
    ...
    def is_offerbook_syncing(self, ) -> "bool":
        return _UniffiConverterBool.lift(
            _uniffi_rust_call_with_error(_UniffiConverterTypeTakerError,_UniffiLib.uniffi_coinswap_ffi_fn_method_taker_is_offerbook_syncing,self._uniffi_clone_pointer(),)
        )
    ...
    def setup_logging(self, data_dir: "typing.Optional[str]") -> None:
        ...
        _uniffi_rust_call_with_error(_UniffiConverterTypeTakerError,_UniffiLib.uniffi_coinswap_ffi_fn_method_taker_setup_logging,self._uniffi_clone_pointer(),
        _UniffiConverterOptionalString.lower(data_dir))
    ...
    def setup_logging_with_level(self, data_dir: "typing.Optional[str]",log_level: "str") -> None:
        ...
        _uniffi_rust_call_with_error(_UniffiConverterTypeTakerError,_UniffiLib.uniffi_coinswap_ffi_fn_method_taker_setup_logging_with_level,self._uniffi_clone_pointer(),
        _UniffiConverterOptionalString.lower(data_dir),
...
class TaprootTaker():
    ...
    def is_offerbook_syncing(self, ) -> "bool":
        return _UniffiConverterBool.lift(
            _uniffi_rust_call_with_error(_UniffiConverterTypeTakerError,_UniffiLib.uniffi_coinswap_ffi_fn_method_taproottaker_is_offerbook_syncing,self._uniffi_clone_pointer(),)
        )
